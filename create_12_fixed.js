// Versão corrigida para 12 jogadores
function create12PlayerStructureFixed() {
  console.log("=== ESTRUTURA CORRIGIDA PARA 12 JOGADORES ===\n");
  
  // Nova estrutura sem repetições
  const structure = {
    rounds: [
      // Rodada 1
      [
